...
var carsAfter2001 = cars.filter(function (car) { return car.year > 2001; });
...
var printId = function (id) {
    var arr = [1, 2, 3].map(function (value) {
        ...
        //   return value + id;
        // }
        return typeof id === "string" ? value + parseInt(id) : value + id;
    });
    return arr;
};
// Type Assertions
...
var printText = function (text, aligment) {
    // do something
};
// Narrowing
...
var car1 = {
    ...
    color: "red",
    gears: "auto",
    startEngine: function (miliseconds) { return "Engine Started ".concat(miliseconds); }
};
